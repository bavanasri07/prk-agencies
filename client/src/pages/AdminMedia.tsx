...
type FormState = { imageUrl: string; videoUrl: string; posterUrl: string; altText: string; caption: string };
const emptyForm: FormState = { imageUrl: "", videoUrl: "", posterUrl: "", altText: "", caption: "" };
...
export default function AdminMedia() {
  ...
  useEffect(() => {
    ...
    records.forEach((record) => { next[record.sectionKey] = { imageUrl: record.imageUrl || "", videoUrl: record.videoUrl || "", posterUrl: record.posterUrl || "", altText: record.altText || "", caption: record.caption || "" }; });
    setForms(next);
  }, [records]);

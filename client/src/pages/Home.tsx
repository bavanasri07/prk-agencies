    ...
    <div className="site-shell">
      ...
      <main>
        <section id="home" className="hero-section">
          <img src={ASSETS.hero} alt="PRK Agencies delivery route in Trichy" className="hero-image" />
          ...
          <div className="hero-bottom page-width"><span>01 / 09</span><span className="hero-scroll"><span /> SCROLL TO EXPLORE</span><span>EST. ROUTE / LOCAL REACH</span></div>
        </section>
        ...
        <section id="about" className="intro-section page-width section-pad reveal-section">
          ...
          <div className="intro-visual"><img src={ASSETS.operations} alt="Organized warehouse distribution activity" /><div className="image-caption"><span>THE WORK BEHIND THE ROUTE</span><span>TRICHY / 10.79° N</span></div></div>
        </section>
        ...
        <section id="products" className="products-section section-pad">
          ...
          <div className="product-runway page-width">{products.map((product, index) => <article className="product-card" key={product.name}><div className="product-media"><img src={product.image} alt={product.name} /><span className="product-index">0{index + 1}</span></div><div className="product-info"><span className="eyebrow">{product.type}</span><h3>{product.name}</h3><p>{product.note}</p><a href="#enquiry">VIEW PRODUCT <ChevronRight size={16} /></a></div></article>)}</div>
        </section>
        ...
        <section id="contact" className="trichy-section"><img src={ASSETS.trichy} alt="Trichy, Tamil Nadu at golden hour" /><div className="trichy-overlay" /><div className="page-width trichy-content"><SectionLabel number="07" light>HOME BASE</SectionLabel><h2>Trichy.<br /><em>Our home base.</em></h2><p>Serving businesses and customers from Trichy, Tamil Nadu, with dependable distribution and supply solutions.</p><span className="location-stamp">TIRUCHIRAPPALLI · TAMIL NADU</span></div></section>
